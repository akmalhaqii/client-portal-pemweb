            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <div class="p-6 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50/50">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('invoices.export.excel', request()->query()) }}" class="inline-flex items-center bg-white border border-slate-200 text-slate-600 px-4 py-2 rounded-xl hover:bg-slate-50 hover:text-green-600 transition-colors text-sm font-medium shadow-sm">
